...
namespace jsIO
{
  ...
  int jsWriterInput::initGridAxis(int _axisInd, AxisLabel _label, Units _units, DataDomain _domain,
  ...
  void jsWriterInput::addSurveyGeom(int i1, int i2, int i3, int i4,
