...
// /********* here comes all other properties
  ...
  survGeom.setGeom(minILine, maxILine, minXLine, maxILine, xILine1End, yILine1End, xILine1Start, yILine1Start,
      xXLine1End, yXLine1End);
...
int CustomProperties::save(std::string &XMLstring) {
  ...
  survGeom.getGeom(minILine, maxILine, minXLine, maxXLine, xILine1End, yILine1End, xILine1Start, yILine1Start,
      xXLine1End, yXLine1End);

  XMLstring = "  <parset name=\"CustomProperties\">\n";

  for (int i = 0; i < m_properties.size(); i++) {
    XMLstring += "    <par name=\"" + m_properties[i].name + "\" type=\"" + m_properties[i].type + "\"> "
        + m_properties[i].value + " </par>\n";
  }
