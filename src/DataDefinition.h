...
namespace jsIO
{
  class DataDefinition
  {
    public:
      ...
      DataFormat getTraceFormat() { return(m_traceFormat); }
      JS_BYTEORDER getByteOrder() { return(m_byteOrder); }
      std::string getDataTypeString() { return(m_dataType.toString()); }
      std::string getTraceFormatString() { return(m_traceFormat.toString());}
