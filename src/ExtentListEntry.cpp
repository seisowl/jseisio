...
namespace jsIO
{
  ...
  ExtentListEntry::ExtentListEntry( std::string &_extName, int _extIndex, long _extStartOff, long _extSize, std::string &_path ) {
  ...
  {
    TRACE_PRINTF(ExtentListEntryLog, "Name=%s, Index=%d, StartOffset=%li, Size=%li, Path=%s", extentName.c_str(),extentIndex, extentStartOffset, extentSize, extentPath.c_str());
  }
