...
namespace jsIO
{
  ...
  std::vector<PropertyDescription> const& TraceProperties::defaultProperties() { static std::vector<PropertyDescription> const _ (initDefaultProperties()); return _; }
  std::vector<PropertyDescription> const& TraceProperties::knownProperties()  { static std::vector<PropertyDescription> const _ (initKnownProperties()); return _; }
 ...
 */
  ...
  int TraceProperties::saveTraceHeader(std::string filename, int firstTrace, int numOfTraces, const bool append){
    ...
    if(firstTrace<0 || numOfTraces <0 || firstTrace + numOfTraces > NTraces){
      ERROR_PRINTF(TracePropertiesLog, "Error: illegal parameeters. It must be %d >=0 , %d>0 and %d+%d<=%d.",
                   firstTrace, numOfTraces, firstTrace, numOfTraces, NTraces);
      return JS_USERERROR;
    }
...
//    propD.print_info();
  ...
  int TraceProperties::InitHdrEntries()
  {
    ...
    for(int i=0;i<N;i++){
      hdrEntries[i].Init(propList[i].getLabel(),propList[i].getDescription(), propList[i].getFormat(), propList[i].getCount(), propList[i].getOffset());
  ...
  std::vector<PropertyDescription> TraceProperties::initKnownProperties()
  {
    ...
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_TRC_TYPE], JS_HEADER_DESC[JSHDR_TRC_TYPE], JS_HEADER_TYPES_INT[JSHDR_TRC_TYPE], 1)); 
    ...
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_OFFSET_BIN], JS_HEADER_DESC[JSHDR_OFFSET_BIN], JS_HEADER_TYPES_INT[JSHDR_OFFSET_BIN], 1)); 
    ...
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_INLINE_NO], JS_HEADER_DESC[JSHDR_INLINE_NO], JS_HEADER_TYPES_INT[JSHDR_INLINE_NO], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_XLINE_NO], JS_HEADER_DESC[JSHDR_XLINE_NO], JS_HEADER_TYPES_INT[JSHDR_XLINE_NO], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_TFULL_E], JS_HEADER_DESC[JSHDR_TFULL_E], JS_HEADER_TYPES_INT[JSHDR_TFULL_E], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_TLIVE_E], JS_HEADER_DESC[JSHDR_TLIVE_E], JS_HEADER_TYPES_INT[JSHDR_TLIVE_E], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_TFULL_S], JS_HEADER_DESC[JSHDR_TFULL_S], JS_HEADER_TYPES_INT[JSHDR_TFULL_S], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_TLIVE_S], JS_HEADER_DESC[JSHDR_TLIVE_S], JS_HEADER_TYPES_INT[JSHDR_TLIVE_S], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_LEN_SURG],JS_HEADER_DESC[JSHDR_LEN_SURG], JS_HEADER_TYPES_INT[JSHDR_LEN_SURG], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_TOT_STAT],JS_HEADER_DESC[JSHDR_TOT_STAT],JS_HEADER_TYPES_INT[JSHDR_TOT_STAT], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_NA_STAT], JS_HEADER_DESC[JSHDR_NA_STAT],JS_HEADER_TYPES_INT[JSHDR_NA_STAT], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_AMP_NORM],JS_HEADER_DESC[JSHDR_AMP_NORM],JS_HEADER_TYPES_INT[JSHDR_AMP_NORM], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_TR_FOLD], JS_HEADER_DESC[JSHDR_TR_FOLD], JS_HEADER_TYPES_INT[JSHDR_TR_FOLD], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_SKEWSTAT],JS_HEADER_DESC[JSHDR_SKEWSTAT], JS_HEADER_TYPES_INT[JSHDR_SKEWSTAT], 1)); 
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_PAD_TRC], JS_HEADER_DESC[JSHDR_PAD_TRC], JS_HEADER_TYPES_INT[JSHDR_PAD_TRC], 1));  
    props.push_back(PropertyDescription(JS_HEADER_NAMES[JSHDR_NMO_APLD],JS_HEADER_DESC[JSHDR_NMO_APLD], JS_HEADER_TYPES_INT[JSHDR_NMO_APLD], 1));  
