...
// private atributes
    ...
    public:
      ...
      AxisDefinition(AxisLabel _label, Units _units, DataDomain _domain,
      ...
      void Init(AxisLabel _label, Units _units, DataDomain _domain,
                long _length, long _logicalOrigin, long _logicalDelta,
                double _physicalOrigin, double _physicalDelta,
                std::string _headerName="", std::string _headerBinName="");
      ...
      AxisLabel getLabel() const {return(label);}
      Units getUnits() const {return(units);}
      DataDomain getDomain() const {return(domain);}
      long getLength() const {return(length);}
      long getLogicalOrigin() const { return(logicalOrigin);}
      long getLogicalDelta() const {return(logicalDelta);}
      double getPhysicalOrigin() const {return(physicalOrigin);}
      double getPhysicalDelta() const {return(physicalDelta);} 
      std::string getHeaderName() const {return(headerName);} 
      std::string getHeaderBinName() const {return(headerBinName);} 
