...
namespace jsIO
{
  class ExtentListEntry{
    public:
      ...
      std::string getPath() const { return extentPath ;}
      int getIndex() const{return extentIndex;}
      long getStartOffset() const{return extentStartOffset;}
      void setStartOffset(long _extentStartOffset) {extentStartOffset=_extentStartOffset;}

      long getExtentSize() const {return extentSize;}
      void setExtentSize(long _extentSize) {extentSize=_extentSize;}
