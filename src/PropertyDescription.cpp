...
namespace jsIO
{
  ...
  PropertyDescription::PropertyDescription(std::string _label, std::string _description, std::string _formatstring, int _count)
  {
  ...
  void PropertyDescription::set(std::string _label, std::string _description,
                                int _format, int _count, int _offset) 
  {
    label = _label;
  ...
  void PropertyDescription::set(std::string _label, std::string _description,
                                std::string _formatstring, int _count, int _offset) 
  {
    int _format = getFormat(_formatstring);
  ...
  {
    std::string str_error="Could not parse property string: '"+_propertyString
        +"' for label='"+_label+"' (expecting at least 4 values)";
    label = _label;
  ...
  void PropertyDescription::print_info() const
  {
    printf("Label:%s , Description=%s, count=%d, format=%d, formatLenght=%d, recordLength=%d, offset=%d\n",
           label.c_str(), description.c_str(), count, format, formatLength, recordLength, offset);
  }
