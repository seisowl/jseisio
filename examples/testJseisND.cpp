...
int main(int argc, char *argv[]) {
  ...
  jsIO::oJseisND jsnd(fname, ndim, lengths, logicalOrigins, logicalDeltas, physicalOrigins, physicalDeltas, axisHdrs, jsIO::DataFormat::FLOAT,
                      true, &extHdrs, &extHdrsType);
  ...
  cout << "finish 2 volume" << endl;
  jsnd2.Close();
  cout << "finish 2" << endl;

  // step 4.3 : write volume and header with frames
  jsIO::oJseisND jsnd3(fname3, ndim, lengths, logicalOrigins, logicalDeltas, physicalOrigins, physicalDeltas, axisHdrs,
                       jsIO::DataFormat::FLOAT);
  ivolume = 4;
  ihyper = 1;
  ...
  jsIO::oJseisND jsnd4(fname4, ndim, lengths, logicalOrigins, logicalDeltas, physicalOrigins, physicalDeltas, axisHdrs,
                       jsIO::DataFormat::FLOAT);
  ivolume = 4;
  ihyper = 1;
